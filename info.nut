class FunAI extends AIInfo {
	function GetAuthor()      { return "Matt Dunford"; }
	function GetName()        { return "FunAI"; }
	function GetDescription() { return "An AI to play with the AI"; }
	...
	function GetSettings() {
	    ...
	    AddSetting({name = "ActivitySigns", description = "Place signs showing what we are doing", easy_value = 1, medium_value = 1, hard_value = 1, custom_value = 1, flags = AICONFIG_BOOLEAN|AICONFIG_INGAME});
